...
# Default image dimensions: 1024x1024 / 1536x1024 (landscape) / 1024x1536 (portrait) / auto.
...
| Prefix | Slash | Description |
|---|---|---|
| `!generate [--landscape\|--portrait\|--square] <prompt>` | `/generate [aspect]` | Generate an image (current image model and default size — see `/model`) |
